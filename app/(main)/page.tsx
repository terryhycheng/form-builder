...
const GetStartedCta = () => {
    return (
    <div className="overflow-hidden bg-gray-50 dark:bg-background py-8">
        <div className="max-w-[85rem] mx-auto px-4 sm:px-6 lg:px-8 py-20">
            <div className="relative mx-auto max-w-4xl grid space-y-5 sm:space-y-10">
                <div className="text-center flex flex-col justify-center items-center gap-4">
                    <h1 className="text-3xl text-gray-800 font-bold sm:text-5xl lg:leading-tight dark:text-gray-200">
                        Ready to Transform Your <span className="text-blue-500">Form-Building</span> Experience?
                    </h1>
                    <p className="text-lg font-semibold text-gray-500 tracking-wide my-2 dark:text-gray-400">
                        Sign up for FormCraftHub today and experience the joy of creating forms that not only look great but work seamlessly.
                    </p>
