...
const forms = [
    {
        id: 1,
        title: 'Front-End Developer Application',
        description: 'A simple web developer application form.',
        type: 'Application',
    },
    {
        id: 2,
        title: 'New Housing Services',
        description: 'Market research to find out what services can be improved.',
        type: 'Questionnaire',
    },
    {
        id: 3,
        title: 'Customer Website Feedback',
        description: 'A form to grab some feedback information on the website.',
        type: 'Feedback',
    },
];
